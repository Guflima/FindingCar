        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ route('dashboard.index') }}">
                <div class="sidebar-brand-icon">
                    <i class=""><img src="{{asset('imagens/logo/siaLogo.png')}}" width="45" height="45" class="d-inline-block" alt=""></i>
                </div>
                <div class="sidebar-brand-text mx-3">SIA Eventos</div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="">Gerenciar Usuários</a>
                        <a class="collapse-item" href="{{ route('users.create') }}">Cadastrar Usuário</a>
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ route('home.index') }}">
                    <i><img src="{{ asset('imagens/icon/voltar.png') }}" style="width: 1.5em; heigth: 1.5em;" ></i>
                <span>Voltar para o sistema</span></a>
            </li>
                            ...
                            <li class="nav-item dropdown no-arrow">
                                ...
                                <div class="dropdown-menu dropdown-menu-right shadow  " aria-labelledby="userDropdown">
                                    ...
                                    <a class="dropdown-item animate slideIn" style="{{ request()->routeIs('myprofile*') ? 'background-color: #343A40; color: #fff' : '' }}" href="{{ route('myprofile.index') }}" id="dropPersonalizado">
                                        <i class="fas fa-user fa-sm fa-fw mr-2 text-gray-400"></i>@lang('layouts/admin/estruturaDaPagina/conteudo.meu_perfil')
                                    </a>
        
                                    <a class="dropdown-item animate slideIn" href="#" id="dropPersonalizado">
                                        <i class="fas fa-cogs fa-sm fa-fw mr-2 text-gray-400"></i>@lang('layouts/admin/estruturaDaPagina/conteudo.configurações')
                                    </a>
        
                                    <a class="dropdown-item animate slideIn" href="#" id="dropPersonalizado">
                                        <i class="fas fa-list fa-sm fa-fw mr-2 text-gray-400"></i>@lang('layouts/admin/estruturaDaPagina/conteudo.logs_de_Atividade')
                                    </a>
        
                                    <div class="dropdown-divider"></div>
        
                                    <a class="dropdown-item animate slideIn" href="#" data-toggle="modal" data-target="#logoutModal" id="dropPersonalizado">
                                        <i class="fas fa-sign-out-alt fa-sm fa-fw mr-2 text-gray-400"></i>@lang('layouts/admin/estruturaDaPagina/conteudo.logout')
                                    </a>

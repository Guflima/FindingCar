            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    ...
                    class="{{ request()->routeIs('home.index') ? 'nav-link active' : 'nav-link' }}">
                        @lang('layouts/estruturaDaPagina/conteudo.home')
                    </a>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <a class="{{ request()->routeIs('eventos*') ? 'nav-link dropdown-toggle active' : 'nav-link dropdown-toggle' }}"
                        ...
                        <div class="dropdown-menu animate slideIn" aria-labelledby="navbarDropdown">
                            ...
                            style="{{ request()->routeIs('eventos.index') ? 'background-color: #343A40;
                            color: #fff;' : '' }}"
                            ...
                            style="{{ request()->routeIs('eventos.create') ? 'background-color: #343A40;
                            color: #fff;' : '' }}"
                            id="dropPersonalizado">
                            @lang('layouts/estruturaDaPagina/conteudo.cadastrar_cliente')
                            </a>
                            <!--
                                Fim option
                               Cadastrar evento
                    ...
                    @if(auth()->user()->role_id == 5)
                        ...
                        class="{{ request()->routeIs('dashboard.index') ? 'nav-link active' : 'nav-link' }}">
                            @lang('layouts/estruturaDaPagina/conteudo.dashboard')
                        </a>
                    @endif

...
/***Biblioteca de gráficos que o prof jenzura quer até 17:15 */
use App\Phplot\PHPlot;
...
class graphicController extends Controller
{
   ...
   public function index(){
        ...
        for ($i = 0; $i < $n_points; $i++) {
            ...
            # Dados do gráfico que se altera
        ...
        $plot->SetTitle("Jenzura's Graphic!");
        ...
        return view('graphicExemple.index', ["plot" => $plot->DrawGraph()]);
   }
}
